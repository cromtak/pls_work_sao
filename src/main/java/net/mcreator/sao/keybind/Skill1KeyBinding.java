...
import net.mcreator.sao.procedures.SkillUseProcedure;
...
public class Skill1KeyBinding extends SaoModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public Skill1KeyBinding(SaoModElements instance) {
		super(instance, 59);
	...
	public void initElements() {
		keys = new KeyBinding("key.sao.skill_1", GLFW.GLFW_KEY_R, "key.categories.misc");
