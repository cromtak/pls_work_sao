...
import net.mcreator.sao.procedures.AllySkeletonKnightOnInitialEntitySpawnProcedure;
import net.mcreator.sao.item.LongSwordItem;
import net.mcreator.sao.entity.renderer.AllySkeletonPaladinRenderer;
...
public class AllySkeletonPaladinEntity extends SaoModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
			.size(0.6f, 1.8f)).build("ally_skeleton_paladin").setRegistryName("ally_skeleton_paladin");

	public AllySkeletonPaladinEntity(SaoModElements instance) {
		super(instance, 170);
		FMLJavaModLoadingContext.get().getModEventBus().register(new AllySkeletonPaladinRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -6710887, -6684673, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("ally_skeleton_paladin_spawn_egg"));
	}
	...
	public static class CustomEntity extends CreatureEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			experienceValue = 0;
			setNoAI(false);
			this.setItemStackToSlot(EquipmentSlotType.MAINHAND, new ItemStack(LongSwordItem.block));
		...
		public ILivingEntityData onInitialSpawn(IServerWorld world, DifficultyInstance difficulty, SpawnReason reason,
			...
			AllySkeletonKnightOnInitialEntitySpawnProcedure
