...
@OnlyIn(Dist.CLIENT)
public class BoarRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(BoarEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelBoar(), 0.7999999999999999f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("sao:textures/boar.png");
					}
				};
			});
		}
