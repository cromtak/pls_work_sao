...
@OnlyIn(Dist.CLIENT)
public class NicholasRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(NicholasEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelNicholasTheRenegade3(), 1.2f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("sao:textures/nicholas3.png");
					}
				};
			});
		}
