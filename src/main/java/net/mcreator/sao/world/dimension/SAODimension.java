...
package net.mcreator.sao.world.dimension;
...
public class SAODimension extends SaoModElements.ModElement {
	public SAODimension(SaoModElements instance) {
		super(instance, 19);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		...
		replaceableBlocks.add(ForgeRegistries.BIOMES.getValue(new ResourceLocation("sao:flat")).getGenerationSettings().getSurfaceBuilder().get()
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("sao:sao"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
