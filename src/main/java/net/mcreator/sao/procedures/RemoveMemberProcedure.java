...
public class RemoveMemberProcedure {

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				SaoMod.LOGGER.warn("Failed to load dependency entity for procedure RemoveMember!");
			return;
		}
		if (dependencies.get("guistate") == null) {
			if (!dependencies.containsKey("guistate"))
				SaoMod.LOGGER.warn("Failed to load dependency guistate for procedure RemoveMember!");
			return;
		}
		...
		HashMap guistate = (HashMap) dependencies.get("guistate");
		{
			String _setval = (((entity.getCapability(SaoModVariables.PLAYER_VARIABLES_CAPABILITY, null)
					.orElse(new SaoModVariables.PlayerVariables())).party).replace(new Object() {
