...
public class NightSkyItem extends SaoModElements.ModElement {
	@ObjectHolder("sao:night_sky")
	public static final Item block = null;

	public NightSkyItem(SaoModElements instance) {
		super(instance, 117);
	}
