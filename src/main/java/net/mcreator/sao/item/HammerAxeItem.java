...
public class HammerAxeItem extends SaoModElements.ModElement {
	@ObjectHolder("sao:hammer_axe")
	public static final Item block = null;

	public HammerAxeItem(SaoModElements instance) {
		super(instance, 180);
	}
	...
	public void initElements() {
		elements.items.add(() -> new SwordItem(new IItemTier() {
			...
			public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				...
				list.add(new StringTextComponent("One-Handed HammerAxe"));
			}
		}.setRegistryName("hammer_axe"));
	}
}
