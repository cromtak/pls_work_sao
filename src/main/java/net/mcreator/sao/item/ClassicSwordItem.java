...
public class ClassicSwordItem extends SaoModElements.ModElement {
	@ObjectHolder("sao:classic_sword")
	public static final Item block = null;

	public ClassicSwordItem(SaoModElements instance) {
		super(instance, 1);
	}
