...
public class Dagger2Item extends SaoModElements.ModElement {
	@ObjectHolder("sao:dagger_2")
	public static final Item block = null;

	public Dagger2Item(SaoModElements instance) {
		super(instance, 196);
	}
	...
	public void initElements() {
		elements.items.add(() -> new SwordItem(new IItemTier() {
			...
			public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				...
				list.add(new StringTextComponent("One-Handed Dagger"));
			}
		}.setRegistryName("dagger_2"));
	}
}
