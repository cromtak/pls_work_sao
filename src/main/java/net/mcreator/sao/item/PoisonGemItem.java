...
public class PoisonGemItem extends SaoModElements.ModElement {
	@ObjectHolder("sao:poison_gem")
	public static final Item block = null;

	public PoisonGemItem(SaoModElements instance) {
		super(instance, 194);
	}
