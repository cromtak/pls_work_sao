...
public class DarkRepulserItem extends SaoModElements.ModElement {
	@ObjectHolder("sao:dark_repulser")
	public static final Item block = null;

	public DarkRepulserItem(SaoModElements instance) {
		super(instance, 115);
	}
