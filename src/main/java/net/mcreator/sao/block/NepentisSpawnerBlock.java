...
import net.mcreator.sao.procedures.NepentisSpawnerBProcedure;
...
public class NepentisSpawnerBlock extends SaoModElements.ModElement {
	@ObjectHolder("sao:nepentis_spawner")
	public static final Block block = null;

	public NepentisSpawnerBlock(SaoModElements instance) {
		super(instance, 82);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("nepentis_spawner");
		}
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			NepentisSpawnerBProcedure.executeProcedure(Stream
