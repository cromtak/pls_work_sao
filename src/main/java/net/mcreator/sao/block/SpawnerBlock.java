...
import net.mcreator.sao.procedures.SpawnerUpdateTickProcedure;
...
public class SpawnerBlock extends SaoModElements.ModElement {
	@ObjectHolder("sao:spawner")
	public static final Block block = null;

	public SpawnerBlock(SaoModElements instance) {
		super(instance, 58);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			SpawnerUpdateTickProcedure.executeProcedure(Stream
