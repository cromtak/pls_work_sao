...
import net.mcreator.sao.procedures.WolfSpawnerBProcedure;
...
public class WolfSpawnerBlock extends SaoModElements.ModElement {
	@ObjectHolder("sao:wolf_spawner")
	public static final Block block = null;

	public WolfSpawnerBlock(SaoModElements instance) {
		super(instance, 77);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			WolfSpawnerBProcedure.executeProcedure(Stream
