...
import net.mcreator.sao.procedures.BoardSpawnerBProcedure;
...
public class BoardSpawnerBlock extends SaoModElements.ModElement {
	@ObjectHolder("sao:board_spawner")
	public static final Block block = null;

	public BoardSpawnerBlock(SaoModElements instance) {
		super(instance, 79);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			BoardSpawnerBProcedure.executeProcedure(Stream
